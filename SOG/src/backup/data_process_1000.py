...
def main(csv_file, output_dir):
    ...
    for index, (i, row) in enumerate(df.iterrows(), start=0):
        ...
        contract_creation_tx = row['contract_name']
        ...
        if bytecode != "" and bytecode != "0x":
            try:
                ...
                results_df = pd.DataFrame(results, columns=['contract_name', 'Time'])
...
if __name__ == "__main__":
    csv_file = 'data/compile_evation.csv'
    output_dir = '/home/sandra/projects/DATA/SOG_SET/compile_evasion'
