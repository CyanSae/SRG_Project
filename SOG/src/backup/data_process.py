...
def main(csv_file, output_dir):
    ...
    for index, (i, row) in enumerate(df.iterrows(), start=171):
        ...
        directory = 'src/174/adversarial_contracts_bytecode'
        ...
        results_df.to_csv('data/output/processing_times3.csv', index=False)
...
if __name__ == "__main__":
    csv_file = 'src/174/Incident.csv'
    output_dir = 'src/174/174_sog'
